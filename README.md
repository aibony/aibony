...
| Capabilities | **546** |
| Dependency edges | **854** |
| Python modules | **959** |
| Test files | **534** |
| Decision records (ADR) | **30** |
| Kernel directives | **205** |
| Governance gate | **FAIL · 60.0/100** |
| Version history | **692.5 MB** |

Open PRs **30** · open branches **91** · all of it under a **2 GB VRAM** ceiling.

Last sync **2026-08-05 03:30 UTC** · [raw feed](https://aibony.github.io/stats.json) · [live architecture graph](https://aibony.github.io/architecture.html) · [live status page](https://aibony.github.io/systems.html)
<!-- NINA:LIVE:END -->
