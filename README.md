...
| Capabilities | **546** |
| Dependency edges | **850** |
| Python modules | **885** |
| Test files | **552** |
| Decision records (ADR) | **39** |
| Kernel directives | **205** |
| Governance gate | **PASS · 100.0/100** |
| Version history | **795.4 MB** |

Open PRs **30** · open branches **260** · all of it under a **2 GB VRAM** ceiling.

Last sync **2026-08-10 08:00 UTC** · [raw feed](https://aibony.github.io/stats.json) · [live architecture graph](https://aibony.github.io/architecture.html) · [live status page](https://aibony.github.io/systems.html)
<!-- NINA:LIVE:END -->
