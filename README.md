...
| Capabilities | **546** |
| Dependency edges | **882** |
| Python modules | **984** |
| Test files | **539** |
| Decision records (ADR) | **34** |
| Kernel directives | **205** |
| Governance gate | **PASS · 100.0/100** |
| Version history | **756.4 MB** |

Open PRs **3** · open branches **3** · all of it under a **2 GB VRAM** ceiling.

Last sync **2026-08-07 00:00 UTC** · [raw feed](https://aibony.github.io/stats.json) · [live architecture graph](https://aibony.github.io/architecture.html) · [live status page](https://aibony.github.io/systems.html)
<!-- NINA:LIVE:END -->
