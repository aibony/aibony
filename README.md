...
| Capabilities | **784** |
| Dependency edges | **907** |
| Python modules | **913** |
| Test files | **566** |
| Decision records (ADR) | **39** |
| Kernel directives | **205** |
| Governance gate | **FAIL · 76.0/100** |
| Version history | **680.3 MB** |

Open PRs **9** · open branches **9** · all of it under a **2 GB VRAM** ceiling.

Last sync **2026-08-12 19:30 UTC** · [raw feed](https://aibony.github.io/stats.json) · [live architecture graph](https://aibony.github.io/architecture.html) · [live status page](https://aibony.github.io/systems.html)
<!-- NINA:LIVE:END -->
