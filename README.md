...
| Capabilities | **546** |
| Dependency edges | **848** |
| Python modules | **884** |
| Test files | **552** |
| Decision records (ADR) | **39** |
| Kernel directives | **205** |
| Governance gate | **FAIL · 76.0/100** |
| Version history | **791.0 MB** |

Open PRs **30** · open branches **301** · all of it under a **2 GB VRAM** ceiling.

Last sync **2026-08-09 20:30 UTC** · [raw feed](https://aibony.github.io/stats.json) · [live architecture graph](https://aibony.github.io/architecture.html) · [live status page](https://aibony.github.io/systems.html)
<!-- NINA:LIVE:END -->
