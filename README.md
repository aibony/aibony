...
| Capabilities | **784** |
| Dependency edges | **942** |
| Python modules | **962** |
| Test files | **563** |
| Decision records (ADR) | **40** |
| Kernel directives | **205** |
| Governance gate | **FAIL · 76.0/100** |
| Version history | **697.8 MB** |

Open PRs **5** · open branches **5** · all of it under a **2 GB VRAM** ceiling.

Last sync **2026-08-13 16:30 UTC** · [raw feed](https://aibony.github.io/stats.json) · [live architecture graph](https://aibony.github.io/architecture.html) · [live status page](https://aibony.github.io/systems.html)
<!-- NINA:LIVE:END -->
